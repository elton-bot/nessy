// Pure household reducer — NO React, NO browser APIs — so the exact same logic
// runs in the client and in the Node sync server. This is what makes the ERP
// rules identical on every device sharing a household.
import type {
